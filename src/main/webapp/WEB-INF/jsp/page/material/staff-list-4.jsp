...
<!DOCTYPE html>
<!-- saved from url=(0051)http://vip2-gd.youshang.com/settings/staff-list.jsp -->
<html>
<head>
...
<div class="wrapper">
    <div class="mod-toolbar-top cf">
        ...
        <div class="fr"><a href="http://vip2-gd.youshang.com/settings/staff-list.jsp#"
                           class="ui-btn ui-btn-sp mrb ui-btn-add" id="btn-add">新增</a>
            <!--<a class="ui-btn mrb" id="btn-disable">禁用</a><a class="ui-btn mrb" id="btn-enable">启用</a>-->
            <!--<a class="ui-btn mrb" id="btn-print">打印</a>--><!--<a class="ui-btn mrb" id="btn-import">导入</a>-->
            <!--<a class="ui-btn mrb" id="btn-export">导出</a>--><a class="ui-btn" id="btn-refresh">刷新</a></div>
    </div>
    <div class="grid-wrap">
            ...
            <div class="ui-jqgrid-view" id="gview_grid" style="width: 1354px;">
                ...
                <div class="ui-state-default ui-jqgrid-hdiv ui-corner-top" style="width: 1354px;">
                    <div class="ui-jqgrid-hbox">
                        <table class="ui-jqgrid-htable" style="width:1050px" role="grid" aria-labelledby="gbox_grid"
                            ...
                            <tr class="ui-jqgrid-labels" role="rowheader">
                                ...
                                <th id="grid_number" role="columnheader" class="ui-state-default ui-th-column ui-th-ltr"
                                    style="width: 150px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                                                style="cursor: col-resize;">&nbsp;</span>
                                    <div id="jqgh_grid_number" class="ui-jqgrid-sortable">职员编号<span class="s-ico"
                                                                                                    style="display:none"><span
                                            sort="asc"
                                            class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                            sort="desc"
                                ...
                                <th id="grid_name" role="columnheader" class="ui-state-default ui-th-column ui-th-ltr"
                                    style="width: 350px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                                                style="cursor: col-resize;">&nbsp;</span>
                                    <div id="jqgh_grid_name" class="ui-jqgrid-sortable">职员名称<span class="s-ico"
                                                                                                  style="display:none"><span
                                            sort="asc"
                                            class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                            sort="desc"
                    ...
                    <div style="position:relative;">
                        ...
                        <table id="grid" tabindex="0" cellspacing="0" cellpadding="0" border="0" role="grid"
                            ...
                            <tr class="jqgfirstrow" role="row" style="height:auto">
                                ...
                                <td role="gridcell" style="height:0px;width:350px;"></td>
                                <td role="gridcell" style="height:0px;width:350px;"></td>
...
<script src="../../js/judgment/staffList.js"></script>
