...
<!DOCTYPE html>
<!-- saved from url=(0052)http://vip2-gd.youshang.com/settings/vendor-list.jsp -->
<html>
<head>
...
<div class="bill-ser-top">
    <ul class="ul-inline cf">
        ...
        <li class="chk-list" id="chk-ischecked" style="display: list-item;">
            <span class="chk over"><input type="checkbox" value="ischecked" name="ischecked">显示禁用供应商</span>
        </li>
...
<div class="wrapper btc">
    <div class="ui-config-box">
	        <span id="config" class="ui-config">
	        	<a href="http://vip2-gd.youshang.com/settings/vendor-list.jsp#" class="ui-icon-config-new"></a>
	        	列设置
	        	</span>
    </div>
    ...
    <div class="bill-ser-botm cf">
        <div class="fr">
            <a href="http://vip2-gd.youshang.com/settings/vendor-list.jsp#" class="ui-btn ui-btn-sp mrb ui-btn-add"
               id="btn-add">新增</a>
            ...
            <a href="http://vip2-gd.youshang.com/settings/vendor-list.jsp#" class="ui-btn mrb ui-btn-normal"
               id="btn-import">导入</a>
            <a href="http://vip2-gd.youshang.com/settings/vendor-list.jsp#" class="ui-btn mrb ui-btn-normal"
               id="btn-export">导出</a>
            <a href="http://vip2-gd.youshang.com/settings/vendor-list.jsp#" class="ui-btn ui-btn-normal"
            ...
            <div class="ui-jqgrid-view" id="gview_grid" style="width: 1371px;">
                ...
                <div class="ui-state-default ui-jqgrid-hdiv ui-corner-top" style="width: 1371px;">
                    <div class="ui-jqgrid-hbox">
                        <table class="ui-jqgrid-htable" style="width:1340px" role="grid" aria-labelledby="gbox_grid"
                            ...
                            <tr class="ui-jqgrid-labels" role="rowheader">
                                ...
                                <th id="grid_customerType" role="columnheader"
                                    class="ui-state-default ui-th-column ui-th-ltr" style="width: 100px;"><span
                                        class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                        style="cursor: col-resize;">&nbsp;</span>
                                    <div id="jqgh_grid_customerType" class="ui-jqgrid-sortable">供应商类别<span class="s-ico"
                                                                                                           style="display:none"><span
                                            sort="asc"
                                            class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                            sort="desc"
                                ...
                                <th id="grid_number" role="columnheader" class="ui-state-default ui-th-column ui-th-ltr"
                                    style="width: 100px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                                                style="cursor: col-resize;">&nbsp;</span>
                                    <div id="jqgh_grid_number" class="ui-jqgrid-sortable">供应商编号<span class="s-ico"
                                                                                                     style="display:none"><span
                                            sort="asc"
                                            class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                            sort="desc"
                                ...
                                <th id="grid_name" role="columnheader" class="ui-state-default ui-th-column ui-th-ltr"
                                    style="width: 220px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                                                style="cursor: col-resize;">&nbsp;</span>
                                    <div id="jqgh_grid_name" class="ui-jqgrid-sortable">供应商名称<span class="s-ico"
                                                                                                   style="display:none"><span
                                            sort="asc"
                                            class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                            sort="desc"
                                ...
                                <th id="grid_contacter" role="columnheader"
                                    class="ui-state-default ui-th-column ui-th-ltr" style="width: 100px;"><span
                                        class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                        style="cursor: col-resize;">&nbsp;</span>
                                    <div id="jqgh_grid_contacter" class="ui-jqgrid-sortable">首要联系人<span class="s-ico"
                                                                                                        style="display:none"><span
                                            sort="asc"
                                            class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                            sort="desc"
                                ...
                                <th id="grid_address" role="columnheader"
                                    class="ui-state-default ui-th-column ui-th-ltr" style="width: 180px;"><span
                                        class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                        style="cursor: col-resize;">&nbsp;</span>
                                    <div id="jqgh_grid_address" class="ui-jqgrid-sortable">联系地址<span class="s-ico"
                                                                                                     style="display:none"><span
                                            sort="asc"
                                            class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                            sort="desc"
                                ...
                                <th id="grid_difMoney" role="columnheader"
                                    class="ui-state-default ui-th-column ui-th-ltr" style="width: 100px;"><span
                                        class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                        style="cursor: col-resize;">&nbsp;</span>
                                    <div id="jqgh_grid_difMoney" class="ui-jqgrid-sortable">应付款余额<span class="s-ico"
                                                                                                       style="display:none"><span
                                            sort="asc"
                                            class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                            sort="desc"
                ...
                <div class="ui-jqgrid-bdiv" style="height: 465px; width: 1371px;">
    ...
    <script src="../../js/judgment/vendorList.js"></script>

</div>
<ul id="tree3006" class="ztree ztreeCombo showRoot" style="max-height: 200px; top: 143px; left: 524px; width: 250px;">
    <li id="tree3006_1" class="level0" tabindex="0" hidefocus="true" treenode=""><span id="tree3006_1_switch" title=""
                                                                                       class="button level0 switch root_docu"
                                                                                       treenode_switch=""></span><a
            id="tree3006_1_a" class="level0" treenode_a="" onclick="" target="_blank" style="" title="请选择供应商类别"><span
            id="tree3006_1_ico" title="" treenode_ico="" class="button ico_docu" style=""></span><span
            id="tree3006_1_span">请选择供应商类别</span></a></li>
</ul>
