...
<div class="wrapper">
    ...
    <div class="bills cf">
        <div class="con-header">
            <dl class="cf">
                ...
                <dd id="identifier" style="float:right">
                    <label>单据编号:</label>
                    <span id="number">GHDD20171121001</span>
                    <i id="editBills"></i>
                                    ...
                                    <tr class="ui-jqgrid-labels" role="rowheader">
                                        ...
                                        <th id="grid_description" role="columnheader"
                                            class="ui-state-default ui-th-column ui-th-ltr" style="width: 150px;"><span
                                                class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                                style="cursor: col-resize;">&nbsp;</span>
                                            <div id="jqgh_grid_description" class="ui-jqgrid-sortable"style="text-align:left">备注<span
                                                    class="s-ico" style="display:none"><span sort="asc" class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span ort="desc"
                                                                                                                                                                                                                     class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr"></span></span>
                                            </div>
                                        </th>
                        ...
                        <div class="ui-jqgrid-bdiv" style="height: 100%; width: 1307px;">
                            <div style="position:relative;">
                                ...
                                <table id="grid" tabindex="0" cellspacing="0" cellpadding="0" border="0" role="grid"
                                    ...
                                    <tr role="row" id="1" tabindex="-1" class="ui-widget-content jqgrow ui-row-ltr" style="position:relative">
                                        <td role="gridcell" class="ui-state-default jqgrid-rownum"
                                            style="text-align:center;width: 28px;" title="1" aria-describedby="grid_rn">
                                            1
                                        </td>
                                        <td role="gridcell" style="text-align:left; z-index: 999" aria-describedby="grid_operating">
                                        ...
                                        <td role="gridcell" style="" aria-describedby="grid_mainUnit">
                                            <input type="text"  class="textbox" style="width: 69px;height:35px;border: none;text-align:center">
                                            &nbsp;</td>
                                        ...
                                        <td role="gridcell" style="" aria-describedby="grid_locationName">
                                            <input type="text"  class="textbox" style="width: 85px;height:35px; border: none;text-align:center">
                                            &nbsp;</td>


                                        <td role="gridcell" style="text-align:right;"
                                            aria-describedby="grid_discountRate">
                                            <input type="text"  class="textbox" style="width: 70px;height:35px; border: none;text-align:center">&nbsp;</td>

                                        <td role="gridcell" style="text-align:right;" aria-describedby="grid_deduction">
                                            <input type="text"  class="textbox" style="width: 80px;height:35px; border: none;text-align:center">   &nbsp;</td>



                                        <td role="gridcell" style="text-align:right;" aria-describedby="grid_amount">
                                            <input type="text"  class="textbox" style="width: 110px;height:35px; border: none;text-align:center">  &nbsp;</td>
                                    ...
                                    <tr role="row" id="3" tabindex="-1" class="ui-widget-content jqgrow ui-row-ltr" style="position:relative">
                                        <td role="gridcell" class="ui-state-default jqgrid-rownum"
                                            style="text-align:center;width: 28px;" title="1" aria-describedby="grid_rn">
                                            3
                                        </td>
        ...
        <div class="con-footer cf">
          ...
          <input type="text" class="input-txt" autocomplete="off" style="width: 84px;"><i class="trigger"></i></span><a id="accountInfo" class="ui-icon ui-icon-folder-open" style="display:none;"></a>
                </li>
                <li>
                    <label>本次欠款:</label>
                ...
                <li>
                    ...
                    <a id="expenseList" style="display:inline-block;height:27px;padding-top:7px;text-decoration:underline;">采购销售费用清单</a>
                </li>
                <li class="dn">
                    <label>累计欠款:</label>
            ...
            <input type="text" class="input-txt" autocomplete="off" style="width: 84px;"><i
                            class="trigger"></i></span><a id="accountInfo" class="ui-icon ui-icon-folder-open"
            ...
            <div class="cf fr">
                <a href="http://vip2-gd.youshang.com/scm/invPo.do?action=initPo&amp;beginDate=2017-11-01&amp;endDate=2017-11-21#"
