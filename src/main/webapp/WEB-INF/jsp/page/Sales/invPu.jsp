        ...
        <div class="con-header">
            <dl class="cf">
                <dd class="mr20">
                    ...
                    <span class="ui-combo-wrap" id="customer" style="width: 198.009px;">

          <i class="ui-icon-ellipsis"></i><input type="text" name="" class="input-txt" autocomplete="off" value="" data-ref="date" style="width: 188.009px;"></span></dd>
                <dd id="identifier" class="mr20 tc">
                    <label>销售人员:</label>
                    <span class="ui-combo-wrap" id="sales" style="width: 118.009px;">

          <input type="text" class="input-txt" autocomplete="off" style="width: 92.0093px;"><i class="trigger"></i></span>
                </dd>
                <dd class="mr20 tc">
                    <label>单据日期:</label>
                    ...
                    <div class="ui-jqgrid-view" id="gview_grid" style="width: 1550px;">
                        <div class="ui-state-default ui-jqgrid-hdiv ui-corner-top" style="width: 1307px;">
                            <div class="ui-jqgrid-hbox">
                                <table class="ui-jqgrid-htable" style="width:1392px" role="grid" aria-labelledby="gbox_grid" cellspacing="0" cellpadding="0" border="0">
                                    <thead>
                                    <tr class="ui-jqgrid-labels" role="rowheader">
                                        ...
                                        <th id="grid_operating" role="columnheader" class="ui-state-default ui-th-column ui-th-ltr" style="width: 0px;">
                                            <span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                            <div id="jqgh_grid_operating" class="ui-jqgrid-sortable">
                                                <span class="s-ico" style="display:none"><span sort="asc" class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span>
                                                    <span sort="desc" class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr"></span></span>
                                            </div>
                                        </th>
                                        <th id="grid_goodId" role="columnheader" class="ui-state-default ui-th-column ui-th-ltr" style="width: 1px; display: none;">
                                            <span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                        ...
                                        <th id="grid_goods" role="columnheader" class="ui-state-default ui-th-column ui-th-ltr" style="width: 300px;">
                                            <span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                        ...
                                        <th id="grid_mainUnit" role="columnheader" class="ui-state-default ui-th-column ui-th-ltr" style="width: 80px;">
                                            <span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
