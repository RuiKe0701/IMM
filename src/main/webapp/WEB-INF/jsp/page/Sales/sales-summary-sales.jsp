...
<div class="wrapper">
    ...
    <div class="mod-search cf" id="report-search">
        <div class="l" id="filter-menu">
            ...
            <a href="http://vip2-gd.youshang.com/report/sales-summary-sales.jsp?beginDate=2017-11-01&amp;endDate=2017-11-21#"
    ...
    <div class="ui-print" style="display: none;">
        ...
        <div class="cf box-flex">
            <div class="flex">
                <span id="config" class="ui-config"><a
                        href="http://vip2-gd.youshang.com/report/sales-summary-sales.jsp?beginDate=2017-11-01&amp;endDate=2017-11-21#"
                        class="ui-icon-config-new"></a>列设置</span>
            </div>
            <div class="grid-title flex">销售汇总表（按销售人员）</div>
            <div class="fr">
                <a href="http://vip2-gd.youshang.com/report/sales-summary-sales.jsp?beginDate=2017-11-01&amp;endDate=2017-11-21#"
        ...
        <div class="grid-wrap" id="grid-wrap" style="height: 591px;">
            <!-- <div class="grid-title">销售汇总表（按销售人员）</div> -->
                ...
                <div class="ui-jqgrid-view" id="gview_grid" style="width: 1334px;">
                    ...
                    <div class="ui-state-default ui-jqgrid-hdiv ui-corner-top" style="width: 1334px;">
                        <div class="ui-jqgrid-hbox">
                            <table class="ui-jqgrid-htable" style="width:1095px" role="grid" aria-labelledby="gbox_grid"
                                ...
                                <tr class="ui-jqgrid-labels" role="rowheader">
                                    <th id="grid_buNo" role="columnheader"
                                        ...
                                        <div id="jqgh_grid_buNo" class="ui-jqgrid-sortable">销售人员<span class="s-ico"
                    ...
                    <div class="ui-jqgrid-sdiv" style="width: 1334px;">
                        <div class="ui-jqgrid-hbox">
                            <table role="grid" style="width:1095px" class="ui-jqgrid-ftable" cellspacing="0"
...
<!--<script src="/js/dist/sales-summary-sales.js?ver=201711161647"></script>-->
<script src="${pageContext.request.contextPath }/js/judgment/sales-summary-sales.js"></script>
...
<div class="pika-single is-hidden is-bound" style=""></div>
<ul id="tree9243" class="ztree ztreeCombo showRoot" style="top: 143px; left: 524px; width: 250px;">
    <li id="tree9243_1" class="level0" tabindex="0" hidefocus="true" treenode=""><span id="tree9243_1_switch" title=""
                                                                                       class="button level0 switch root_docu"
                                                                                       treenode_switch=""></span><a
            id="tree9243_1_a" class="level0" treenode_a="" onclick="" target="_blank" style=""><span id="tree9243_1_ico"
                                                                                                     title=""
                                                                                                     treenode_ico=""
                                                                                                     class="button ico_docu"
                                                                                                     style=""></span><span
            id="tree9243_1_span">全部</span></a></li>
</ul>
