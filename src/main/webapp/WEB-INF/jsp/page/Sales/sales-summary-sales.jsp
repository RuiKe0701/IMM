    ...
    <div class="wrapper">
        ...
        <div class="bills cf">
            <div class="con-header">
                ...
                <hr class="hrcls">
                <div class="grid-title flex" style="text-align:center"><label style="font-size: large">销售汇总表（按销售人员)</label> </div>
            </div>
        </div>
    </div>
    ...
    <form id="form">
        ...
        <div style="position: relative;left: 50px">
            ...
            <div class="ads" id="dsa" style="position: absolute;right: 100px;top: 370px;">
                <ul class="pagination" >
                    <li><a href="?start=0&employeeId=${sales.employeeId}&merchandiseId=${sales.merchandiseId}&productTypeId=${sales.productTypeId}">首页</a></li>
                    ...
                    <c:forEach begin="1" end="${len}" varStatus="status">
                        <li><a href="?start=${page.start=status.index}&employeeId=${sales.employeeId}&merchandiseId=${sales.merchandiseId}&productTypeId=${sales.productTypeId}">${status.index}</a></li>
                    </c:forEach>
                    ...
                    <%--</c:if>--%>
                    <li><a href="?start=${page.last}&employeeId=${sales.employeeId}&merchandiseId=${sales.merchandiseId}&productTypeId=${sales.productTypeId}">末页</a></li>
