    ...
    <div class="mod-search cf" id="report-search">
        <div class="l" id="filter-menu">
            <ul class="ul-inline fix" id="filterItems">
                ...
                <li id="goods" style="display: list-item;"><label>客户:</label><span class="mod-choose-input"
                                                                                   id="filter-goods"><input type="text"
                                                                                                            class="ui-input"
                                                                                                            id="goodsAuto"
                                                                                                            autocomplete="off"><span
                        class="ui-icon-ellipsis"></span></span></li>
                <li id="billNum" style="display: list-item;"><label>商品类别</label><input type="text" value=""
                                                                                       style="width:115px;"
                ...
                <div class="ui-jqgrid-view" id="gview_grid" style="width: 1205px;">
                    ...
                    <div class="ui-state-default ui-jqgrid-hdiv ui-corner-top" style="width: 1205px;">
                        <div class="ui-jqgrid-hbox">
                            <table class="ui-jqgrid-htable" style="width: 1215px;" role="grid"
                                ...
                                <tr class="ui-jqgrid-labels" role="rowheader">
                                    <th id="grid_assistName" role="columnheader"
                                        ...
                                        aria-selected="false"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                    ...
                                    <th id="grid_secondUnit" role="columnheader"
                                        ...
                                        style="width: 100px; display: none;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                        <div id="jqgh_grid_secondUnit" class="ui-jqgrid-sortable">辅助单位<span
                                                class="s-ico" style="display:none"><span sort="asc"
                                                                                         class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                                sort="desc"
                                                class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr"></span></span>
                                    ...
                                    <th id="grid_secondQty" role="columnheader"
                                        ...
                                        style="width: 100px; display: none;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                        <div id="jqgh_grid_secondQty" class="ui-jqgrid-sortable">辅助数量<span class="s-ico"
                                                                                                           style="display:none"><span
                                                sort="asc"
                                                class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                                sort="desc"
                                    ...
                                    <th id="grid_qty" role="columnheader"
                                        class="ui-state-default ui-th-column ui-th-ltr" style="width: 100px;"
                                        aria-selected="true"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
                                                                   style="cursor: col-resize;">&nbsp;</span>
                                    ...
                                    <th id="grid_amount" role="columnheader"
                                        ...
                                        <div id="jqgh_grid_amount" class="ui-jqgrid-sortable">销售收入<span class="s-ico"
                                                                                                        style="display: none;"><span
                                                sort="asc"
                                                class="ui-grid-ico-sort ui-icon-asc ui-icon ui-icon-triangle-1-n ui-sort-ltr ui-state-disabled"></span><span
                                                sort="desc"
                                                class="ui-grid-ico-sort ui-icon-desc ui-icon ui-icon-triangle-1-s ui-sort-ltr ui-state-disabled"></span></span><span
                        ...
                        <div class="ui-jqgrid-hbox">
                            <table role="grid" style="width: 1215px;" class="ui-jqgrid-ftable" cellspacing="0"
                                ...
                                <tr role="row" class="ui-widget-content footrow footrow-ltr">
                                    ...
                                    <td role="gridcell" style="width: 100px; border-right-color: rgb(255, 255, 255);"
                                        class="ui-ellipsis" aria-describedby="grid_location">&nbsp;
                                    </td>
                                    <td role="gridcell"
                                        style="width: 100px; border-right-color: rgb(255, 255, 255); display: none;"
