        ...
        <div class="l" id="filter-menu">
            <ul class="ul-inline fix" id="filterItems">
                ...
                <li id="bill_title"><label>发票抬头:</label><input type="text" class="ui-input ui-input-ph"
                                                               id="billTitleAuto"></li>
                <li id="filter"><label>客户类别:</label><span id="catorage"></span></li>
            ...
            <a href="http://vip2-gd.youshang.com/report/sales-summary.jsp?beginDate=2017-11-01&amp;endDate=2017-11-21#"
        ...
        <div class="cf box-flex">
            <div class="flex">
                <span id="config" class="ui-config"><a
                        href="http://vip2-gd.youshang.com/report/sales-summary.jsp?beginDate=2017-11-01&amp;endDate=2017-11-21#"
                ...
                <div class="ui-jqgrid-view" id="gview_grid" style="width: 1334px;">
                    ...
                    <div class="ui-state-default ui-jqgrid-hdiv ui-corner-top" style="width: 1334px;">
                        <div class="ui-jqgrid-hbox">
                            <table class="ui-jqgrid-htable" style="width:1215px" role="grid" aria-labelledby="gbox_grid"
                                ...
                                <tr class="ui-jqgrid-labels" role="rowheader">
                                    ...
                                    <th id="grid_buNo" role="columnheader"
                                        ...
                                        style="width: 150px; display: none;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                        <div id="jqgh_grid_buNo" class="ui-jqgrid-sortable">客户编码<span class="s-ico"
                                    ...
                                    <th id="grid_locationNo" role="columnheader"
                                        ...
                                        style="width: 150px; display: none;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                        <div id="jqgh_grid_locationNo" class="ui-jqgrid-sortable">仓库编码<span
                                                class="s-ico" style="display:none"><span sort="asc"
                                                                                         class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                                sort="desc"
                                                class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr"></span></span>
                    ...
                    <div class="ui-jqgrid-sdiv" style="width: 1334px;">
                        <div class="ui-jqgrid-hbox">
                            <table role="grid" style="width:1215px" class="ui-jqgrid-ftable" cellspacing="0"
                                ...
                                <tr role="row" class="ui-widget-content footrow footrow-ltr">
                                    ...
                                    <td role="gridcell" style="width: 100px; border-right-color: rgb(255, 255, 255);"
                                        class="ui-ellipsis" aria-describedby="grid_location">&nbsp;</td>
                                    <td role="gridcell" style="width: 100px; border-right-color: rgb(255, 255, 255);"
...
<script src="${pageContext.request.contextPath }/js/judgment/salesSummary.js"></script>
...
<div class="pika-single is-hidden is-bound" style=""></div>
<ul id="tree2622" class="ztree ztreeCombo showRoot" style="top: 143px; left: 524px; width: 250px;">
    <li id="tree2622_1" class="level0" tabindex="0" hidefocus="true" treenode=""><span id="tree2622_1_switch" title=""
                                                                                       class="button level0 switch root_docu"
                                                                                       treenode_switch=""></span><a
            id="tree2622_1_a" class="level0" treenode_a="" onclick="" target="_blank" style=""><span id="tree2622_1_ico"
                                                                                                     title=""
                                                                                                     treenode_ico=""
                                                                                                     class="button ico_docu"
                                                                                                     style=""></span><span
            id="tree2622_1_span">全部</span></a></li>
</ul>
