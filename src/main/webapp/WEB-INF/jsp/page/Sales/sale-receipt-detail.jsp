...
<body style="">
<form  action="/saleReceipt/loginSaleReceipt.do"  method="post">
    ...
    <div class="wrapper">
        ...
        <div class="bills cf">
            <div class="con-header">
                ...
                <hr class="hrcls">
                <div class="grid-title flex" style="text-align:center"><label style="font-size: large">销售收款一览表</label> </div>
            </div>
        </div>
    </div>
