        ...
        <div class="l" id="filter-menu">
            <ul class="ul-inline fix" id="filterItems">
                ...
                <li id="filter" style="display: list-item;"><label>客户类别</label><span class="ui-tree-wrap"
                                                                                     style="width:174px"><input
                        type="text" class="input-txt" style="width:148px" id="catorage" autocomplete="off"
            ...
            <a href="http://vip2-gd.youshang.com/report/sales-summary-customer-new.jsp?beginDate=2017-11-01&amp;endDate=2017-11-21#"
        ...
        <div class="cf box-flex">
            <div class="flex">
                <span id="config" class="ui-config"><a
                        href="http://vip2-gd.youshang.com/report/sales-summary-customer-new.jsp?beginDate=2017-11-01&amp;endDate=2017-11-21#"
            ...
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" id="gbox_grid" dir="ltr"
                ...
                <div class="ui-jqgrid-view" id="gview_grid" style="width: 1334px;">
                    ...
                    <div class="ui-jqgrid-sdiv" style="width: 1334px;">
                        <div class="ui-jqgrid-hbox">
                            <table role="grid" style="width:1080px" class="ui-jqgrid-ftable" cellspacing="0"
                                ...
                                <tr role="row" class="ui-widget-content footrow footrow-ltr">
                                    ...
                                    <td role="gridcell"
                                        style="text-align: center; width: 80px; border-right-color: rgb(255, 255, 255);"
                                        aria-describedby="grid_buName">&nbsp;</td>
                                    <td role="gridcell"
                                        style="text-align: center; width: 80px; border-right-color: rgb(255, 255, 255);"
                                    ...
                                    <td role="gridcell"
                                        style="text-align: center; width: 80px; border-right-color: rgb(255, 255, 255);"
                                        aria-describedby="grid_secondUnit">&nbsp;</td>
                                    <td role="gridcell"
                                        style="text-align: center; width: 80px; border-right-color: rgb(255, 255, 255);"
                                        aria-describedby="grid_secondQty">&nbsp;</td>
                                    <td role="gridcell" style="text-align:center;width: 100px;"
                                        aria-describedby="grid_unit">&nbsp;</td>
                                    <td role="gridcell" style="text-align:right;width: 60px;"
                                    ...
                                    <td role="gridcell" style="display:none;width: 150px;"
                                        aria-describedby="grid_locationNo">&nbsp;</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
...
<script src="${pageContext.request.contextPath }/js/judgment/salesSummaryCustomerNew.js"></script>
...
<div class="pika-single is-hidden is-bound" style=""></div>
<ul id="tree6046" class="ztree ztreeCombo showRoot" style="max-height: 147px; top: 143px; left: 524px; width: 250px;">
    <li id="tree6046_1" class="level0" tabindex="0" hidefocus="true" treenode=""><span id="tree6046_1_switch" title=""
                                                                                       class="button level0 switch root_docu"
                                                                                       treenode_switch=""></span><a
            id="tree6046_1_a" class="level0" treenode_a="" onclick="" target="_blank" style=""><span id="tree6046_1_ico"
                                                                                                     title=""
                                                                                                     treenode_ico=""
                                                                                                     class="button ico_docu"
                                                                                                     style=""></span><span
            id="tree6046_1_span"></span></a></li>
</ul>
