...
<div class="wrapper">
        ...
        <div class="l" id="filter-menu">
            <ul class="ul-inline fix" id="filterItems">
                ...
                <li id="billNum" style="display: list-item;">
                    <label>客户类别</label>
                    <input type="text" value="" style="width:115px;" class="ui-input ui-input-ph" name="matchCon" id="matchCon">
                </li>
    ...
    <div class="ui-print" style="display: none;">
        ...
        <div class="cf box-flex">
            ...
            <div class="grid-title flex">销售汇总表（按客户）</div>
            <div class="fr">
                ...
                <div class="ui-jqgrid-view" id="gview_grid" style="width: 1205px;">
                    ...
                    <div class="ui-state-default ui-jqgrid-hdiv ui-corner-top" style="width: 1205px;">
                        <div class="ui-jqgrid-hbox">
                            <table class="ui-jqgrid-htable" style="width: 1200px;" role="grid"
                                ...
                                <tr class="ui-jqgrid-labels" role="rowheader">
                                    <th id="grid_assistName" role="columnheader"
                                        ...
                                        <div id="jqgh_grid_assistName" class="ui-jqgrid-sortable">客户类别<span
                                    ...
                                    <th id="grid_invName" role="columnheader"
                                        class="ui-state-default ui-th-column ui-th-ltr" style="width: 78px;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                    ...
                                    <th id="grid_invNo" role="columnheader"
                                        ...
                                        style="width: 175px; display: none;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                    ...
                                    <th id="grid_buName" role="columnheader"
                                        class="ui-state-default ui-th-column ui-th-ltr" style="width: 163px;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                    ...
                                    <th id="grid_qty" role="columnheader"
                                        class="ui-state-default ui-th-column ui-th-ltr" style="width: 111px;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                    ...
                                    <th id="grid_unitPrice" role="columnheader"
                                        class="ui-state-default ui-th-column ui-th-ltr" style="width: 73px;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                    ...
                                    <th id="grid_amount" role="columnheader"
                                        class="ui-state-default ui-th-column ui-th-ltr" style="width: 115px;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                    ...
                                    <th id="grid_buNo" role="columnheader"
                                        class="ui-state-default ui-th-column ui-th-ltr"
                                        style="width: 150px; display: none;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                        <div id="jqgh_grid_buNo" class="ui-jqgrid-sortable">buNo<span class="s-ico"
                                                                                                      style="display:none"><span
                                                sort="asc"
                                                class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                                sort="desc"
                                    ...
                                    <th id="grid_locationNo" role="columnheader"
                                        class="ui-state-default ui-th-column ui-th-ltr"
                                        style="width: 150px; display: none;"><span
                                            class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                        <div id="jqgh_grid_locationNo" class="ui-jqgrid-sortable">locationNo<span
                                                class="s-ico" style="display:none"><span sort="asc"
                                                                                         class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span><span
                                                sort="desc"
                                                class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr"></span></span>
                        ...
                        <div style="position:relative;">
                            ...
                            <table id="grid" tabindex="0" cellspacing="0" cellpadding="0" border="0" role="grid"
                                ...
                                <tr class="jqgfirstrow" role="row" style="height:auto">
                                    ...
                                    <td role="gridcell" style="height: 0px; width: 175px; display: none;"></td>
                                    ...
                                    <td role="gridcell" style="height:0px;width:111px;"></td>
                                    <td role="gridcell" style="height:0px;width:73px;"></td>
                    ...
                    <div class="ui-jqgrid-sdiv" style="width: 1205px;">
                        <div class="ui-jqgrid-hbox">
                            <table role="grid" style="width: 1200px;" class="ui-jqgrid-ftable" cellspacing="0"
                                ...
                                <tr role="row" class="ui-widget-content footrow footrow-ltr">
                                    ...
                                    <td role="gridcell"
                                        style="text-align: center; width: 78px; border-right-color: rgb(255, 255, 255);"
                                        aria-describedby="grid_invName">&nbsp;
                                    </td>
                                    <td role="gridcell"
                                        style="text-align: center; width: 175px; border-right-color: rgb(255, 255, 255); display: none;"
                                    ...
                                    <td role="gridcell"
                                        style="text-align: center; width: 163px; border-right-color: rgb(255, 255, 255);"
                                    ...
                                    <td role="gridcell"
                                        style="text-align: center; width: 80px; border-right-color: rgb(255, 255, 255); display: none;"
                                        aria-describedby="grid_secondQty">&nbsp;
                                    </td>
                                    <td role="gridcell" style="text-align: center; width: 100px;"
                                        aria-describedby="grid_unit">&nbsp;
                                    </td>
                                    <td role="gridcell" style="text-align:right;width: 111px;"
                                        aria-describedby="grid_qty">0
                                    </td>
                                    <td role="gridcell" style="text-align:right;width: 73px;"
                                        aria-describedby="grid_unitPrice">0
                                    </td>
                                    <td role="gridcell" style="text-align:right;width: 115px;"
                                    ...
                                    <td role="gridcell" style="text-align:right;display:none;width: 60px;"
                                        aria-describedby="grid_unitCost">0
                                    </td>
                                    <td role="gridcell" style="text-align:right;display:none;width: 60px;"
                                        aria-describedby="grid_cost">0
                                    </td>
                                    <td role="gridcell" style="text-align:right;display:none;width: 60px;"
                                        aria-describedby="grid_saleProfit">0
                                    </td>
                                    <td role="gridcell" style="text-align:right;display:none;width: 60px;"
                                        aria-describedby="grid_salepPofitRate">0
                                    </td>
                                    <td role="gridcell" style="display:none;width: 150px;" aria-describedby="grid_buNo">
                                        &nbsp;
                                    </td>
