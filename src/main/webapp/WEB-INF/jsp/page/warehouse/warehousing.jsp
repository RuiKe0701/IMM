...
<div class="wrapper">
    <!-- header -->
    <form action="/warehousing/selectwarehousing.do" method="post">
        <div class="mod-search cf" id="report-search">
            <div class="l" id="filter-menu">
                <ul class="ul-inline fix" id="filterItems">
                    <li id="merchandiseForName" style="display: list-item;"><label>待修改</label>
                        <input type="text"  name="merchandiseName">
                    </li>
                    <li id="product" style="display: list-item;"><label>待修改</label>
                    ...
                    <li id="units" style="display: list-item;"><label>待修改</label>
                    ...
                    <li id="salesstatus" style="display: list-item;"><label>待修改</label>
                        <select  name="unitsId" style="width:115px;height: 32px" >
                            <option value="0">请选择</option>
        ...
        <c:forEach var="w" items="${ware}">
            <tr id="${w.warehousingId}">
                ...
                <td style="width: 120px;text-align: center">
                    <button type="button" id="updatemerchandise" onclick="updatemerchandise(${w.warehousingId})" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myUpdate" ><span class="up">修改</span></button>
                    <button type="button" id="${m.merchandiseId}" onclick="deletemerchandise(${w.warehousingId})" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myDelete" ><span  class="up">删除</span></button></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
